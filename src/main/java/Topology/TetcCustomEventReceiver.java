...
public class TetcCustomEventReceiver extends Receiver<String> implements ISyntheticEventGen {
    ...
    public TetcCustomEventReceiver(String filename_, BatchedFileLogging spoutlog_, double _scalingFactor, String _datasetType) {
