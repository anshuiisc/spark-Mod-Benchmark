...
{
//    JavaPairRDD<String, Integer> pairs = inputstream.mapToPair(s -> new Tuple2(s, 1));
...
//                                numCols = 8;
//                                fieldNames = new String[numCols]; colIndexArr = new Integer[numCols];emitlist=new String[numCols];
...
//                                }
//                            }
//                            return MsgIdAddandRemove.addMessageId(Arrays.asList(emitlist),id);
//                        }
//                    });



//    JavaDStream<String> BatchedAggregator=words.filter(new Function<String, Boolean>() {
