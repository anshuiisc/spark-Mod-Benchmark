...
import java.util.Random;
    ...
    public final class TopoRunnerPy {
    private TopoRunnerPy() {
    }


        static JavaDStream<String> sourcestream1=null;
...
//            System.out.println(s);
        ...
        public JavaDStream<String> getStream() {
...
//logging-code ends
        ...
        JavaStreamingContext ssc = new JavaStreamingContext(sparkConf, new Duration(1000));
            ...
            sourcestream1 = ssc.receiverStream(
